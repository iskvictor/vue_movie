              ...
              <div class="single-form-left">
                ...
                <div class="contact-single">
                  <h3 class="editContent">
                    <span class="sub-tittle editContent">{{reviews.length}}</span>Оставить отзыв</h3>
                  <form action="#" method="get" class="mt-4" id="formReview">
                    <div class="form-group editContent">
                      <label for="contactcomment" class="editContent">Ваш комментарий
                        *</label>
                      <textarea class="form-control border" rows="5" id="contactcomment" v-model="text"></textarea>
                    </div>
                    <div class="d-sm-flex">
...
<script>
  export default {
    ...
    methods: {
      ...
      addParent(id){
        this.parent = id
        console.log('sfsfsdfsf',this.parent)
      },
      clearForm(){
        this.name = ''
        this.email = ''
